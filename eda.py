...
def run():
    ...
    # create figure
    fig, axs = plt.subplots(1, 3, figsize=(14,5), facecolor='none')
    ...
    st.markdown("""
        ...
        Other than that, Laptop & Accessory and Mobile phone are still the two most preferred category on both gender. This shows that our most of our customer loves technology.
    """)
    ...
    # preferred order cat
    st.header('**Features That Affects the Likeliness of Customer Churn 🤔**')
    st.markdown("""
